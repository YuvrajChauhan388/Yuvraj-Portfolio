...
export const Bio = {
  ...
  github: "https://github.com/YuvrajChauhan388",
  //resume: "https://drive.google.com/file/d/1ArgTHBUIZekfRfc36OnFf78fUxTGWiaH/view?usp=sharing",
  resume: My_Resume,
  linkedin: "https://www.linkedin.com/in/yuvraj-chauhan-55432827b/",
  // twitter: "https://twitter.com/RishavChanda",
  insta: "https://www.instagram.com/yuvraj._.chauhan_/",
  facebook: "https://www.facebook.com/profile.php?id=100087237680154",
};
...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      //},
      {
        name: "Spring Boot",
        image:
          "https://commons.wikimedia.org/wiki/Special:Redirect/file/Spring_Boot.svg",
      },
      {
        name: "Pandas",
        image:
          "https://commons.wikimedia.org/wiki/Special:Redirect/file/Pandas_logo.svg",
      },
      {
        name: "Vercel",
        image: "https://logo.svgcdn.com/l/vercel.png",
      },
      {
        name: "Streamlit",
        image:
  ...
  //},
  {
    ...
    skills: [
      ...
      {
        name: "Postman",
        image: "https://logo.svgcdn.com/d/postman-original.png",
      },
      //{
      //name: "Adobe XD",
      //image:
...
export const experiences = [
  ...
  },
  {
    ...
    desc: "Developed 'Sibilytics-AI', a Streamlit-based web application for wavelet-based feature extraction from sensor signals (.txt & .lvm). Implemented dynamic wavelet decomposition using Biorthogonal (bior) wavelets (1–20 levels), denoising, statistical, energy-based, and entropy-based feature extraction, real-time visualizations (time-domain, STFT spectrograms, FFT, wavelet decomposition, correlation plots), and CSV export for all calculated parameters. Designed for fast, interactive signal analysis with download options for plots and consolidated statistics.",
    skills: [
      "Python",
      "Streamlit",
      "NumPy",
...
export const projects = [
  {
    ...
    description:
      "Sibilytics-AI is a Streamlit-based web application tailored for wavelet-based feature extraction from time-series sensor signals. Users can upload data in .txt or .lvm formats, dynamically select wavelet decomposition levels (1–20), and process the signals using the Biorthogonal (bior) wavelet. The platform offers interactive visualizations including time-domain plots, STFT spectrograms, FFT plots, and wavelet decomposition views for raw and denoised signals. It also provides correlation plots and allows users to download any plot as PNG. Statistical, energy-based, and entropy-based features can be exported for further analysis.",
  ...
  {
    id: 1,
    title: "AI Email Writer WebApp & Chrome Extension",
    date: "Jul 2025 - Aug 2025",
    description:
      "Developed a React.js WebApp and Chrome Extension for an AI-powered Email Writer Assistant. The application fetches context-aware email replies from a Spring Boot backend API and allows users to auto-generate professional emails with a single click. Features include tone selection (Professional, Friendly, Casual), copy-to-clipboard functionality, and seamless Gmail integration. The frontend is deployed on Vercel for high availability and performance.",
    image: require("./Email_Writier.png"),
    tags: [
      "React.js",
      "Chrome Extension",
      "Material UI",
    ...
    category: "web app",
    github:
      "https://github.com/YuvrajChauhan388/Email-Writer-Extension-Frontend",
    webapp:
      "https://yuvrajchauhan388.github.io/Email-Writer-Extension-Frontend/",
  },
  {
    id: 2,
    title: "OEM Inventory Analysis System",
    date: "May 2025 - Jul 2025",
    description:
      "Built an interactive Streamlit-based OEM Inventory Analysis System for TATA Power/Steel. The app predicts unit prices and replenishment events using historical data, inflation adjustments, and equipment lifetime analysis. Features include advanced data cleaning, year detection using regex, custom price prediction, visualization of replenishment timelines, and CSV export. It enables operational planning and reduces manual data processing for inventory management.",
    image: require("./OEM_System.png"),
    tags: [
      "Streamlit",
      "Python",
      "Pandas",
    ...
    category: "web app",
    github: "https://github.com/YuvrajChauhan388/OEM-Inventory-Analysis",
